...
def main():
  ...
  parser.add_argument('--workload', type=str, default="search", help='Workload')
  ...
  compo = ['performance', 'powerConsumption']
  ...
  for j in range(n_runs):   
      ...
      top_perf_de = np.sort(Yr.powerConsumption.values)[-10]
      ...
      top_perf_sh = np.sort(Yr.powerConsumption.values)[-30]
